 ...
 * 
 */
package de.eorganization.example.client.gui;
...
import de.eorganization.example.client.gui.canvas.ProfileWindow;
...
public class TopLayout extends HLayout {
	...
	public TopLayout(final LoginInfo loginInfo) {
		...
		Anchor crawlerLogo = new Anchor(new SafeHtmlBuilder()
				.appendHtmlConstant(
						Canvas.imgHTML("/images/example_logo.png", 397, 150))
