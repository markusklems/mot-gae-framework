 ...
 * 
 */
package de.eorganization.example.client.gui.canvas;
 ...
 * 
 */
public class WelcomeInfoWindow extends Window {
	 ...
	 * 
	 */
	public WelcomeInfoWindow(final Member member, MemberUpdatedHandler handler) {
		...
		checkboxItem.addChangedHandler(new ChangedHandler() {
			...
			public void onChanged(ChangedEvent event) {
				...
				loginService.updateMember(getMember(), new AsyncCallback<Member>() {
